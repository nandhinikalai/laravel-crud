        ...
        <form action="/products/store" method="POST" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
                <div class="col-md-12">
                    ...
                    <input type="text" name="name" class="form-control @if($errors->has('name')) {{'is-invalid'}} @endif" id="name" placeholder="Enter Product Name" value="{{old('name')}}">
                    @if($errors->has('name'))
            ...
            <div class="row mb-3">
                <div class="col-md-12">
                    ...
                    <textarea name="description" id="describtion" style="resize: none; height: 150px;" class="form-control @if($errors->has('description')) {{'is-invalid'}} @endif" placeholder="Enter Description">{{old('description')}}</textarea>
...
/* Customizations for Form Elements */
